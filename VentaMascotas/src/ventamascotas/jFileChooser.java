...
public class jFileChooser extends javax.swing.JFrame {
    ...
    private void jFileChooser1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jFileChooser1ActionPerformed
        ...
        if(c.equals(JFileChooser.APPROVE_SELECTION)){
            ...
            rutaabsoluta=archivo.getName();
            File archivoimg = new File("RutaImg.txt");
            try{
                archivoimg.createNewFile();
                fos = new FileOutputStream("RutaImg.txt");
                dos = new DataOutputStream(fos);
                dos.writeChars(rutaabsoluta);
                dos.close();
            }catch(IOException e){
            
            }
            this.dispose();
        }else if(c.equals(JFileChooser.CANCEL_SELECTION)){
            this.dispose();
        }
